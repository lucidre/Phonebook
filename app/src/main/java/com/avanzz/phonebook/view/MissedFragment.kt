...
class MissedFragment : Fragment() {
    ...
    private lateinit var missedRecyclerView: RecyclerView
    ...
    companion object {
        fun newInstance(): MissedFragment {
    ...
    override fun onCreateView(
        ...
        missedRecyclerView.layoutManager = LinearLayoutManager(activity)
        //adapter = CallListAdapter()
        //receivedRecyclerView.adapter = adapter
        progress = ProgressDialog(activity)

        LoadCallListTask().execute(CallType.MISSED)
    ...
    private inner class LoadCallListTask : AsyncTask<CallType, Void, List<CallLogItem>>() {
        ...
        override fun onPostExecute(result: List<CallLogItem>) {
            ...
            missedRecyclerView.adapter = adapter
        }
    }
